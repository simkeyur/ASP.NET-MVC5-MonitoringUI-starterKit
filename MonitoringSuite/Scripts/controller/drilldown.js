...
app.controller('dashboardCtrl', function($scope, $http) {
    ...
    $http.get('Scripts/plugins/data/fullfillment_data.json').then(fulfillmentData, fulfillmentError);
    $http.get('Scripts/plugins/data/holds_data.json').then(holdsData, holdsError);
    $http.get('Scripts/plugins/data/exceptions_data.json').then(exceptionsData, exceptionsError);
